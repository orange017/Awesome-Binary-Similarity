# [TREX: Learning Execution Semantics from Micro-Traces for Binary Similarity](https://www.cs.columbia.edu/~suman/docs/trex_final.pdf)
...
### 2.2. Pretraining Masked LM on Micro-traces
...
### 4.4. Finetuning for Function Similarity
